...
if __name__ == '__main__':
    ...
    UserAgentList = ["Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.66 Safari/537.36",
    ...
    for i in range(0, 1000):
        with TorRequest(proxy_port=9150, ctrl_port=9151, password=None) as tr:
            ...
            iUserAgent = randint(0, len(UserAgentList))
            ...
            driver.get("https://youtu.be/12345678901")
